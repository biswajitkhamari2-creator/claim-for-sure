    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <a href="tel:+919439151934" className="inline-flex items-center gap-1.5 rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90">
            Call +91 94391 51934
          </a>
        </div>
      </header>
  ...
  return (
    <div className="mt-8 rounded-xl border border-border bg-muted/40 p-6">
      ...
      <p className="text-sm text-muted-foreground">
        Phone: <a className="text-primary hover:underline" href="tel:+919439151934">+91 94391 51934</a> ·{" "}
        <a className="text-primary hover:underline" href="tel:+918144503650">+91 81445 03650</a>
      </p>
